...
-- Tool launches
local inc_display_brightness = "brightnessctl set +4%"
local inc_display_brightness_fine = "brightnessctl set +1"
local inc_display_brightness_max = "brightnessctl set 100%"
local dec_display_brightness = "brightnessctl set 4%-"
local dec_display_brightness_fine = "brightnessctl set 1-"
local dec_display_brightness_zero = "brightnessctl set 0%"
local maxBrightness_cmd = "brightnessctl set 100%"
local minBrightness_cmd = "brightnessctl set 1"
